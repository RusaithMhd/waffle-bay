-- 00007_inventory_deduction_rpc.sql

-- PostgreSQL function for atomic order checkout with INVENTORY DEDUCTION
...
BEGIN
  ...
  -- 3. Insert Items and Modifiers, and deduct inventory
